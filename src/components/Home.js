...
<div className='navoffset'>
        ...
        <h1 className='intro'>Benefits and risks of living kidney donation</h1>
        <hr/>
        ...
        <p>Living donor surgery</p> <Link to='/Donate' ><span>Donate</span></Link>
        <hr/>
        ...
        <p className='intro'>The surgery</p><Link to='/Donate' ><span>Donate</span></Link>
